...
const VehicleStockApp = () => {
  ...
  const handleAddVehicle = () => {
    ...
    const stock = parseInt(newVehicle.stock);
    let status = 'in-stock';
  ...
  const handleAddSale = () => {
    console.log('Add Sale clicked', newSale);
    ...
    if (newExpense.linkedToStock && newExpense.vehicleId) {
      setVehicles(vehicles.map(v => {
        if (v.id === parseInt(newExpense.vehicleId)) {
          return {
            ...v,
            additionalCosts: v.additionalCosts + parseFloat(newExpense.amount)
          };
        }
        return v;
      }));
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-8 px-6 shadow-lg">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-2">
            <Car size={32} />
            <h1 className="text-3xl font-bold">Vehicle Stock Management</h1>
          </div>
          <p className="text-blue-100">Manage inventory, track sales, and monitor expenses</p>
        </div>
      </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={'text-3xl font-bold mt-1 ' + (profit >= 0 ? 'text-green-600' : 'text-red-600')}>
                  £{(profit / 1000).toFixed(1)}K
                </p>
              </div>
              <TrendingUp className={profit >= 0 ? 'text-green-600' : 'text-red-600'} size={32} />
            </div>
          </div>
        </div>
          ...
          <div className="border-b border-gray-200">
            <div className="flex">
              <button
                ...
                className={'px-6 py-3 font-medium ' + (activeTab === 'inventory' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700')}
              >
              ...
              <button
                ...
                className={'px-6 py-3 font-medium ' + (activeTab === 'sales' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700')}
              >
                <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={'px-6 py-3 font-medium ' + (activeTab === 'expenses' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700')}
              >
                <div className="flex items-center gap-2">
                  <Receipt size={18} />
                  Expenses
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Add Costs</th>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredVehicles.map((vehicle) => (
                      <tr key={vehicle.id} className="hover:bg-gray-50 transition">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-500 font-mono">{vehicle.vin}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-600">
                            £{vehicle.costPrice.toLocaleString()}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-medium text-orange-600">
                            £{vehicle.additionalCosts.toLocaleString()}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-bold text-gray-900">{vehicle.stock} units</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ' + getStatusColor(vehicle.status)}>
                            <span className={'w-2 h-2 rounded-full mr-1.5 ' + getStatusDot(vehicle.status)}></span>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {sales.map((sale) => (
                      <tr key={sale.id} className="hover:bg-gray-50 transition">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-mono text-blue-600">{sale.invoiceNumber}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-medium text-gray-900">{sale.vehicle}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">{sale.customer}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-500">{sale.salesPerson}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Linked Vehicle</th>
                    ...
                    {expenses.map((expense) => {
                      ...
                      return (
                        <tr key={expense.id} className="hover:bg-gray-50 transition">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ' + (expense.linkedToStock ? 'bg-orange-100 text-orange-800' : 'bg-purple-100 text-purple-800')}>
                              {expense.category}
                            </span>
                          </td>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            {linkedVehicle ? (
                              <div className="text-sm text-gray-900">
                                {linkedVehicle.make} {linkedVehicle.model}
                              </div>
                            ) : (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6 max-h-screen overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Cost Price (Purchase)</label>
                <input
                  type="number"
                  value={newVehicle.costPrice}
                  onChange={(e) => setNewVehicle({...newVehicle, costPrice: e.target.value})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="25000"
                />
              </div>
            ...
            <div className="space-y-4">
              <div>
                <label className="flex items-center gap-2 mb-3">
                  <input
                    type="checkbox"
                    checked={newExpense.linkedToStock}
                    onChange={(e) => setNewExpense({
                      ...newExpense, 
                      linkedToStock: e.target.checked,
                      category: e.target.checked ? 'Fuel' : 'Rent'
                    })}
                    className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                  />
                  <span className="text-sm font-medium text-gray-700">Link to Vehicle (incremental cost)</span>
                </label>
              </div>

              {newExpense.linkedToStock && (
                <div>
                  ...
                  >
                    ...
                    {vehicles.map(v => (
                      <option key={v.id} value={v.id}>
                        {v.make} {v.model} {v.year} - Current Add Cost: £{v.additionalCosts.toLocaleString()}
                      </option>
                    ))}
                  </select>
                </div>
              ...
              <div>
                ...
                >
                  {newExpense.linkedToStock ? (
                    stockExpenseCategories.map(cat => (
      ...
      {showInvoiceModal && selectedSale && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-3xl w-full p-8 max-h-screen overflow-y-auto">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h2 className="text-3xl font-bold text-gray-900">SALES INVOICE</h2>
                <p className="text-gray-600 mt-1">{selectedSale.invoiceNumber}</p>
              </div>
            ...
            <div className="border-t border-b border-gray-200 py-6 mb-6">
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-gray-700 font-medium">Your Dealership Name</p>
                  <p className="text-gray-600">123 Business Street</p>
                  <p className="text-gray-600">London, UK</p>
                  <p className="text-gray-600">SW1A 1AA</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Bill To:</h3>
                  <p className="text-gray-700 font-medium">{selectedSale.customer}</p>
                  <p className="text-gray-600">{selectedSale.customerAddress}</p>
                  <p className="text-gray-600 mt-2">Email: {selectedSale.customerEmail}</p>
                  <p className="text-gray-600">Phone: {selectedSale.customerPhone}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-medium">{new Date(selectedSale.date).toLocaleDateString()}</span>
                </div>
                <div>
                  <span className="text-gray-600">Sales Person:</span>
                  <span className="ml-2 font-medium">{selectedSale.salesPerson}</span>
                </div>
              </div>
            </div>
            ...
            <table className="w-full mb-6">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900">Item Description</th>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="px-4 py-4">
                    <div className="font-medium text-gray-900">{selectedSale.vehicle}</div>
                    <div className="text-sm text-gray-600">VIN: {vehicles.find(v => v.id === selectedSale.vehicleId)?.vin}</div>
                  </td>
              ...
              <div className="flex justify-end">
                <div className="w-64">
                  <div className="flex justify-between py-2 text-gray-600">
                    <span>Subtotal:</span>
                    <span>£{selectedSale.salePrice.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between py-2 text-gray-600">
                    <span>VAT (20%):</span>
                    <span>£{(selectedSale.salePrice * 0.2).toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between py-3 border-t border-gray-300 text-lg font-bold text-gray-900">
                    <span>Total:</span>
                    <span>£{(selectedSale.salePrice * 1.2).toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
